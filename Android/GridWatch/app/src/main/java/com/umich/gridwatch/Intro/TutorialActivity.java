...
public class TutorialActivity extends ActionBarActivity implements
    ...
    private AbstractWizardModel mWizardModel = new TutorialWizardModel(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (String.valueOf(mNextButton.getText()).equals(getString(R.string.finish))) {
                    Log.w("DEAR GOD", "hit");
                    finish();
                }
    ...
    public void onPageTreeChanged() {
        ...
        updateBottomBar();
        //Log.w("onPageTreeChanged:pageseq", mCurrentPageSequence.toString());
        //Log.w("onPageTreeChanged:pagerstrip", mStepPagerStrip.toString());
